...
\item Development of the data aquisition software, overhauling the input configuration structure which improved efficiency and ease of use.
\item Calibration of the cosmic ray paddles which were used in every 35~ton analysis.
\item Author of two 35~ton detector papers which currently in preparation.
\end{itemize}
